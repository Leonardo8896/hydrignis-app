...
export default function Politica() {
  ...
  <SafeAreaView style={styles.safeArea}>
    <Text style={{fontFamily:'Inter-regular', marginLeft:15, marginTop:0, color:'#6C7278', fontSize:14}}>Email Atual</Text>
    <TextInput
      style={styles.input}
      placeholder="murilo.haddad@gmail.com"
      placeholderTextColor="#A0A0A0"
      keyboardType="email-address"
      autoCapitalize="none"
    />
    <Text style={{fontFamily:'Inter-regular', marginLeft:15, marginTop:6, color:'#6C7278', fontSize:14}}>Novo Email</Text>
    <TextInput
      style={styles.input}
