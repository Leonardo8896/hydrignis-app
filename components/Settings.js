...
export default function SettingsScreen({navigation}) {
  return (
    ...
    <View style={styles.whitecard}>
      ...
      onPress={() => navigation.navigate('EditarNomeHydralize')}>
      <View>
      <Text style={styles.action}>Editar o nome</Text>
      <Text style={styles.name}>SEF 1 de Murilo</Text>
      </View>
      ...
      <TouchableOpacity style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center', marginTop:2}}
      onPress={() => navigation.navigate('EditarLocalizacaoHydralize')}>
      <View>
    ...
    <View style={styles.whitecard}>
      ...
      <TouchableOpacity style={{flexDirection:'row', justifyContent:'space-between', alignItems:'center', marginTop:2}} onPress={() => navigation.navigate('InformacoesDispositivos')}>
      <View>
