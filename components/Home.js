  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        console.error("[HomeScreen] erro no useEffect:", err);
      }
    };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.whitecard, !ignisPowerOn && styles.disabledCard]}>
        <TouchableOpacity onPress={() => navigation.navigate("Ignis")}>
          <View style={styles.topcard}>
            <View style={styles.rowtopcard}>
              <MaterialCommunityIcons
                name="fire"
                size={24}
                color={ignisPowerOn ? "#AD2831" : "#cccccc"}
              />
              <Text
                style={[
                  styles.nomedispositivo,
                  !ignisPowerOn && styles.disabledText,
                ]}
              >
                Ignis 1 de Murilo
              </Text>
            ...
            <TouchableOpacity onPress={toggleIgnisPower}>
              <View
                style={[
                  styles.powerButton,
                  !ignisPowerOn && styles.powerButtonOff,
                ]}
              >
                <MaterialCommunityIcons
                  name="power"
                  size={18}
                  color={ignisPowerOn ? "#006ED3" : "#cccccc"}
                />
              </View>
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.bottomCard}>
            <Image
              source={require("../assets/Ignis.png")}
              style={styles.hydralize}
            />
            <View
              style={[
                styles.verticalLine,
                !ignisPowerOn && { backgroundColor: "#e8e8e8" },
              ]}
            />
            ...
            <View style={styles.infoContainer}>
              <View style={styles.infoRow}>
                <MaterialCommunityIcons
                  name="signal-variant"
                  size={20}
                  color={ignisPowerOn ? "black" : "#cccccc"}
                />
                <Text
                  style={[
                    styles.textoconexao,
            ...
            <View>
              ...
              <Text
                style={[styles.textStats, !ignisPowerOn && styles.disabledText]}
              >
                {ignisPowerOn ? "Seguro" : "Desligado"}
              </Text>
            </View>
          </View>
        </TouchableOpacity>
