...
export default function FinalizarCadastroSef({navigation}) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <MaterialCommunityIcons name="water" size={24} color="#0077BE" />
      <Text style={{fontFamily:'Inter-regular', fontSize:14, color:'#1d1f24', marginLeft:2}}>Hydralize</Text>
      </View>
      ...
      <TouchableOpacity style={styles.botao} onPress={() => navigation.navigate('SefConcluido')}>
