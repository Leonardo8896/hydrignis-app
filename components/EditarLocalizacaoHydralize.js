...
export default function Politica() {
  ...
  <SafeAreaView style={styles.safeArea}>
    <Text style={{fontFamily:'Inter-regular', marginLeft:15, marginTop:0, color:'#6C7278', fontSize:14}}>Localização atual</Text>
    <TextInput
      style={styles.input}
      placeholder="Piso 3"
      ...
      autoCapitalize="none"
    />
    <Text style={{fontFamily:'Inter-regular', marginLeft:15, marginTop:6, color:'#6C7278', fontSize:14}}>Nova Localização</Text>
    <TextInput
      style={styles.input}
